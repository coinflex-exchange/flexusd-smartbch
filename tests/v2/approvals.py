...
# FILENAME:  tests/v2/approvals.py
# VERSION: 	 1.0
# CREATED: 	 
# AUTHOR: 	 
# DESCRIPTION:
...
def test_approve_small_amount(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_approve_full_balance(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_approve_max(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_approve_above_max(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_approve_overflow(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
