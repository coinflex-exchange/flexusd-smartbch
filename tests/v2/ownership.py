...
# FILENAME:  tests/v2/ownership.py
# VERSION: 	 1.0
# CREATED: 	 
# AUTHOR: 	 
# DESCRIPTION:
...
def test_mint(admin: Account, wrap_flexusd: FlexUSDImplV2):
...
def test_burn(admin: Account, wrap_flexusd: FlexUSDImplV2):
...
def test_pause(admin: Account, wrap_flexusd: FlexUSDImplV2):
...
def test_failed_burn(user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_failed_pause(user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_transfer_ownership(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_transfer_ownership_failed(user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_transfer_ownership_then_failed_mint(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_transfer_ownership_then_failed_burn(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
...
def test_transfer_ownership_then_failed_pause(admin: Account, user_accounts: List[Account], wrap_flexusd: FlexUSDImplV2):
